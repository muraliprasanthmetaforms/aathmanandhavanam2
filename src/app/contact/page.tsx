          ...
          <div className='max-w-4xl mx-auto'>
            <div className='bg-slate-900/50 rounded-lg p-4 md:p-8 shadow-2xl border border-slate-800/50'>
              <div className='text-center mb-12 md:mb-16'>
                <h1 className='text-2xl sm:text-3xl md:text-4xl text-primary-gold mb-4 font-semibold px-2'>
                  Aathmanathavanam
                  <br className='md:hidden' /> Visitor Information
                </h1>
              ...
              <div className='mb-16'>
                <div className='flex items-center gap-3 mb-6'>
                  ...
                  <h2 className='text-2xl text-white font-medium'>Visitor Permission</h2>
                </div>
                <div className='prose prose-lg prose-invert ml-9'>
                  ...
                  <p className='text-slate-300'>
                    ...
                    visitors to obtain prior permission before coming to Aathmanathavanam. This is
                    to maintain the sanctity of the sacred space and ensure that everyone has a
              ...
              <div className='mb-16'>
                <div className='flex items-center gap-3 mb-6'>
                  ...
                  <h2 className='text-2xl text-white font-medium'>Darshan Timings</h2>
                </div>
              ...
              <div className='mb-16'>
                <div className='flex items-center gap-3 mb-6'>
                  ...
                  <h2 className='text-2xl text-white font-medium'>Contact Information</h2>
                </div>
                <div className='space-y-6 text-slate-300 ml-9'>
              ...
              <div className='text-center bg-slate-800/30 p-6 rounded-lg'>
                <p className='text-slate-300'>
                  Please make sure to contact us in advance to schedule your visit. We look forward
                  to welcoming you and sharing the wisdom and tranquility of Aathmanathavanam.
                </p>
              </div>
            </div>
          </div>
